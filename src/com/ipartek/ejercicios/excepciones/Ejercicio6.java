...
*Dicha clase constara con un atributo de tipo int llamado codigoError, asi como un constructor completo solamente (sin métodos get ni set ni constructores vacíos).<br>
*De manera adicional se implementaran los métodos abstractos heredados de la clase, en este caso getMessage().<b>
